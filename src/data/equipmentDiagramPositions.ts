...
export const nodePositions: DiagramPositions = {
  ...
  // Materials (Design & Repair) standards
  "std-astm-dr": { x: -70, y: 0 },
  "std-api-6a": { x: 70, y: 0 },
  "std-asme-ii": { x: 0, y: 80 },
  "std-mds-98": { x: 0, y: 160 },

  // Flare (Design & Repair) standards
  "std-api-521-dr": { x: 0, y: 0 },

  // Heat Exchangers (Design & Repair) standards
  ...
  // Injection / Process Mix Points (Design & Repair) standards
  "std-nace-sp0402": { x: 0, y: 0 },

  // Incident Investigation (MI Engineering) standards
  "std-api-754-ii": { x: 0, y: 0 },

  // HF Alkylation (MI Engineering) standards
  "std-api-751": { x: 0, y: 0 },

  // KPI (MI Engineering) standards
  "std-api-754-kpi": { x: 0, y: 0 },

  // Corrosion Under Insulation/Fireproofing (MI Engineering) standards
  "std-api-583": { x: -100, y: 0 },
  "std-asme-cui-1": { x: 0, y: 0 },
  "std-asme-cui-2": { x: 100, y: 0 },

  // Damage Mechanism (MI Engineering) standards
  ...
  // Corrosion Control (Corrosion) standards
  ...
  // Injection / Process Mix Points (Corrosion) standards
