 ...
 * (UNROTATED) wrapper element — its bounding box center is the pivot the
 ...
 * — that's what makes the handle move/rotate along with the node instead of
  ...
  const onMouseDown = useCallback(
    (event: React.MouseEvent) => {
      ...
      const onMove = (moveEvent: MouseEvent) => {
        ...
        // atan2 measures from the +x axis; +90 so 0° corresponds to "handle straight up".
